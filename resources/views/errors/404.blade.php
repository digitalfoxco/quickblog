...
<div class="row">
	<div class="col s12 m6" style="margin-top:150px; margin-left:500px;">
		 <div class="card blue-grey darken-1 col  s12 m6 l6">
			  <div class="card-content white-text  center">
				  <span class="card-title">Oops Page Not Found</span>
 ...
 <footer class="page-footer teal" style="margin-top:150px;">
    <div class="container">
      <div class="row">
